...
// without delme for ColladaLoader 2       'base_link.dae',
    fetch_dae_files = [
        'base_link_delme.dae',
        'elbow_flex_link_delme.dae',
        'forearm_roll_link_delme.dae',
        'gripper_link_delme.dae',
        'head_pan_link_delme.dae',
        'head_tilt_link_delme.dae',
        'shoulder_lift_link_delme.dae',
        'shoulder_pan_link_delme.dae',
        'torso_fixed_link_delme.dae',
        'torso_lift_link_delme.dae',
        'upperarm_roll_link_delme.dae',
        'wrist_flex_link_delme.dae',
        'wrist_roll_link_delme.dae'
     ];
...
for (i=0;i<fetch_dae_files.length;i++) {
    geom_index = fetch_dae_files[i].split('_delme');
